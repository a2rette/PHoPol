...
{
    /** @var array<string, CobPhpRecord> */
    private array $records    = [];

    /** @var array<string, mixed> */
    private array $standalone = [];

    public function addRecord(string $name, CobPhpRecord $record): void
    {
        $this->records[$name] = $record;
    }

    public function getRecord(string $name): ?CobPhpRecord
    {
    ...
    /** @return array<string, CobPhpRecord> */
...
function bootstrap(string $cobphpFile): WssContext
{
    ...
    foreach ($layouts as $name => $layout) {
        ...
        if ($layout->redefines === null) {
            $record = new CobPhpRecord($layout);
    ...
    foreach ($layouts as $name => $layout) {
        if ($layout->redefines !== null) {
            ...
            $redefRecord = new CobPhpRecord($layout);
