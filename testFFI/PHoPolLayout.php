...
//================================================================
// PHoPolLayout — compile-time descriptor for one level(01) level
//
// Holds:
//   - the total byte length of the level
//   - a flat map of all fields (name → PHoPolField)
//   - the name of the level this one redefines (if any)
//
// Built once by PHoPolParser, shared across all instances
// of the same level type — like a C struct definition.
//================================================================
final class PHoPolLayout
{
    /** @var array<string, PHoPolField> */
    ...
    public function addField(PHoPolField $field): void
    {
        $this->fields[$field->name] = $field;
    }

    public function getField(string $name): ?PHoPolField
    {
        return $this->fields[$name] ?? null;
    }

    /** @return array<string, PHoPolField> */
