...
//================================================================
// PHoPolField — compile-time descriptor for one elementary item
//
// Immutable once built by PHoPolParser.
// Stored in PHoPolLayout, looked up by field name.
//================================================================
final class PHoPolField
{
    public function __construct(
        public readonly string    $name,
        public readonly int       $offset,     // byte offset from level start
        ...
        // Edited picture mask — non-empty only for edited<"..."> fields.
        // When set, encodeDisplay() applies editFormat() automatically on MOVE.
        public readonly string    $editMask    = '',

        // VALUE clause: applied once when a fresh buffer is allocated.
        // $initialIsFill = true  → memset the field bytes with $initialValue[0]
        //                           (used for SPACES, HIGH_VALUES, LOW_VALUES)
        // $initialIsFill = false → encode $initialValue through the normal codec
        //                           (used for literals and ZERO)
        public readonly mixed     $initialValue  = null,
        public readonly bool      $initialIsFill = false,
    ) {}
