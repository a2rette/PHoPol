...
require_once __DIR__ . '/CobPhpField.php';    // enum FieldType must exist before any class that references it
require_once __DIR__ . '/CobPhpLevel.php';    // base class must exist before CobPhpLevel01 autoloads